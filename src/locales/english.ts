...
export const english: Lang = {
	...
	home: {
		description: "Hi, I'm Luciano Morales, a software developer.",
		...
		hobbies:
			'Outside of the programming world, I love music and practice a variety of instruments, mainly guitar and piano.',
